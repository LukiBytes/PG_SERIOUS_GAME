...
public class MemoryGame extends JDialog{
    ...
    public MemoryGame(JFrame parent, int difficulty) {
        ...
        List<Color> colorList = generateSequence(sequenceLength);
        initializeUI();
        start(colorList);
    ...
    public List<Color> generateSequence(int sequenceLength) {
        ...
        System.out.println("Długość sekwencji: " + sequenceLength);

        // Pomieszaj
        Collections.shuffle(list);

        // Zostaw tylko tyle ile potrzeba
    ...
    public void start(List<Color> colorList){
        ...
        timer = new Timer(delay, e -> {
            if (index[0] < colorList.size()){
                ...
                mainColorButton.setText("KONIEC");
            }
    ...
    public void initializeUI(){
        ...
        instructionLabel = new JLabel("Zamapiętaj kolejność kolorów");
